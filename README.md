...
Usage: Just run the python file. If it doesn't find your bike computer you might have to find the name of it and change line 7. Id you don't have a cycplus M1, you'll definitely have to change line 7. This is bluetooth LE, file transfers are not very fast. 
