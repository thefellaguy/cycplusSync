...
Usage: ust run the pythin file. If it doesn;t fibd your bike computer you might have to find the name of it and change like X. Id you don't have a cycplus M1, you'll definitely have to change line X. This is bluetooth LE, file transfers are not very fast. 
